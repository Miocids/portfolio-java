...
import com.portfolio.my_portfolio_backend.service.ExperienceServiceImpl;
...
public class ExperienceController {
    ...
    public String listExperienceByPersonalId(Long personalInfoId, Model model){
    ...
    public String deleteSkill(@PathVariable Long id, RedirectAttributes redirectAttributes){
        try {
            ...
            redirectAttributes.addFlashAttribute("message","Experiencia eliminada con éxito!");
        } catch (Exception e) {
