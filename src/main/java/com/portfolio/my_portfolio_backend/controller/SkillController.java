...
public class SkillController {
    ...
    public String listSkillsByPersonalId(Long personalInfoId, Model model){
    ...
    public String deleteSkill(@PathVariable Long id, RedirectAttributes redirectAttributes){
        try {
            ...
            redirectAttributes.addFlashAttribute("error","Error al eliminar la habiliadad: " + e.getMessage());
        }
